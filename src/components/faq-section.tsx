...
const FAQS: {
  ...
  },
  {
    ...
    sourceIds: ["noaa-crw"],
    confidence: "high",
    caveat: "5 km resolution means the displayed value may not reflect localised upwelling or shaded reef microhabitats.",
  },
  {
  ...
  },
  {
    ...
    a: "Survey freshness shows how many days have elapsed since the most recent peer reviewed data point for that location was published or collected. A green dot means within 365 days. Amber means 1–3 years. Grey means older than 3 years or unknown. Freshness matters because reef conditions can change rapidly after bleaching events — a survey five years old may predate a major mortality event. We surface freshness prominently so you can weigh the confidence in any location's current state.",
    confidence: "high",
  },
  {
